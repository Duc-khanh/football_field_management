...
public class AuthController {
    ...
    public ResponseEntity<?> registerOwner(@RequestBody OwnerRegisterDTO registerDTO) {
        try {
            accountService.registerOwner(registerDTO);
            return ResponseEntity.ok("Đăng ký thành công! Vui lòng chờ Admin duyệt tài khoản.");
