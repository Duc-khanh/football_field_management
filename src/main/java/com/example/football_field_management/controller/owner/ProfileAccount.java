...
public class ProfileAccount {
    ...
    public ProfileAccount(AccountRepository accountRepo) {
        this.accountRepo = accountRepo;
    }

    @GetMapping
    public String editProfileAccount(Model model) {
        ...
        return "owner/cour/profile-account";
    }
    @PostMapping
    public String saveProfileAccount(Account account, MultipartFile avatarFile, RedirectAttributes redirectAttributes) {
        try {
